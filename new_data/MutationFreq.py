...
#Plots of the no corrected and corrected mutation freq for the whole data set
...
with open(os.path.join(sys.path[0], "MutationFreq",'TCGA_prad_maf.csv'.replace(".csv","")+"MutationFreqCorrected.csv"), "w") as thefile:
...
plt.savefig(os.path.join(sys.path[0], "MutationFreq","Corrected Mutation Freq"+".png"),format="png") #Save plot, always above .show !!! Are saved in user
...
plt.savefig(os.path.join(sys.path[0], "MutationFreq","Mutation Freq"+".png"),format="png") #Save plot, always above .show !!! Are saved in user
...
with open(os.path.join(sys.path[0], "MutationFreq",'net1_TCGA_prad_maf.csv'.replace(".csv","")+"MutationFreqCorrected.csv"), "w") as thefile:
...
plt.savefig(os.path.join(sys.path[0], "MutationFreq","net1_Corrected Mutation Freq"+".png"),format="png") #Save plot, always above .show !!! Are saved in user
...
plt.savefig(os.path.join(sys.path[0], "MutationFreq","net1_Mutation Freq"+".png"),format="png") #Save plot, always above .show !!! Are saved in user
...
with open(os.path.join(sys.path[0], "MutationFreq",'net8_TCGA_prad_maf.csv'.replace(".csv","")+"MutationFreqCorrected.csv"), "w") as thefile:
...
plt.savefig(os.path.join(sys.path[0], "MutationFreq","net8_Corrected Mutation Freq"+".png"),format="png") #Save plot, always above .show !!! Are saved in user
...
plt.savefig(os.path.join(sys.path[0], "MutationFreq","net8_Mutation Freq"+".png"),format="png") #Save plot, always above .show !!! Are saved in user
