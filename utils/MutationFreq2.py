...
#Plots of the no corrected and corrected mutation freq for the aggressive and non aggresive data set
...
for cancertype in cancertypesfile:
    ...
    with open(os.path.join(sys.path[0], "MutationFreq",'TCGA_prad_maf.csv'.replace(".csv","") + cancertype + "MutationFreqCorrected.csv"), "w") as thefile:
    ...
    plt.title("Corrected Mutation Freq "+cancertype)
    ...
    plt.savefig(os.path.join(sys.path[0], "MutationFreq","Corrected Mutation Freq "+cancertype+".png"),format="png") #Save plot, always above .show !!! Are saved in user
    ...
    plt.ylabel("Mutation Freq [%]")
    plt.title("Mutation Freq "+cancertype)
    plt.xticks(rotation=16,fontsize=8) # Correct overlapping labels and size

    for i in range(10): #To add the values to the bars
        plt.text(i,genes_df.iloc[i]["MutationFreq%"],round(genes_df.iloc[i]["MutationFreq%"],5), ha = 'center')
    plt.savefig(os.path.join(sys.path[0], "MutationFreq","Mutation Freq "+cancertype+".png"),format="png") #Save plot, always above .show !!! Are saved in user
    ...
    with open(os.path.join(sys.path[0], "MutationFreq",'net1_TCGA_prad_maf.csv'.replace(".csv","")+cancertype+"MutationFreqCorrected.csv"), "w") as thefile:
    ...
    plt.ylabel("Mutation Freq [%]")
    plt.title("Net1 Corrected Mutation Freq "+cancertype)
    plt.xticks(rotation=16,fontsize=8) # Correct overlapping labels and size

    for i in range(10): #To add the values to the bars
        plt.text(i,net1genes_df.iloc[i]["Corrected"],round(net1genes_df.iloc[i]["Corrected"],5), ha = 'center')
    plt.savefig(os.path.join(sys.path[0], "MutationFreq","net1_Corrected Mutation Freq"+cancertype+".png"),format="png") #Save plot, always above .show !!! Are saved in user
    ...
    plt.ylabel("Mutation Freq [%]")
    plt.title("Net1 Mutation Freq "+cancertype)
    plt.xticks(rotation=16,fontsize=8) # Correct overlapping labels and size

    for i in range(10): #To add the values to the bars
        plt.text(i,net1genes_df.iloc[i]["MutationFreq%"],round(net1genes_df.iloc[i]["MutationFreq%"],5), ha = 'center')
    plt.savefig(os.path.join(sys.path[0], "MutationFreq","net1_Mutation Freq"+cancertype+".png"),format="png") #Save plot, always above .show !!! Are saved in user
    ...
    with open(os.path.join(sys.path[0], "MutationFreq",'net8_TCGA_prad_maf.csv'.replace(".csv","")+cancertype+"MutationFreqCorrected.csv"), "w") as thefile:
    ...
    plt.ylabel("Mutation Freq [%]")
    plt.title("Net8 Corrected Mutation Freq "+cancertype)
    plt.xticks(rotation=16,fontsize=8) # Correct overlapping labels and size

    for i in range(10): #To add the values to the bars
        plt.text(i,net8genes_df.iloc[i]["Corrected"],round(net8genes_df.iloc[i]["Corrected"],5), ha = 'center')
    plt.savefig(os.path.join(sys.path[0], "MutationFreq","net8_Corrected Mutation Freq"+cancertype+".png"),format="png") #Save plot, always above .show !!! Are saved in user
    ...
    #plt.xlabel("Interaction Network")
    plt.ylabel("Mutation Freq [%]")
    plt.title("Net8 Mutation Freq "+cancertype)
    plt.xticks(rotation=16,fontsize=8) # Correct overlapping labels and size

    for i in range(10): #To add the values to the bars
        plt.text(i,net8genes_df.iloc[i]["MutationFreq%"],round(net8genes_df.iloc[i]["MutationFreq%"],5), ha = 'center')
    plt.savefig(os.path.join(sys.path[0], "MutationFreq","net8_Mutation Freq"+cancertype+".png"),format="png") #Save plot, always above .show !!! Are saved in user
