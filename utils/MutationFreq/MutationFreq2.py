...
for cancertype in cancertypesfile:
    ...
    with open(os.path.join(sys.path[0], 'TCGA_prad_maf.csv'.replace(".csv","") + cancertype + "MutationFreqCorrected.csv"), "w") as thefile:
    ...
    with open(os.path.join(sys.path[0], 'net1_TCGA_prad_maf.csv'.replace(".csv","")+cancertype+"MutationFreqCorrected.csv"), "w") as thefile:
    ...
    with open(os.path.join(sys.path[0], 'net8_TCGA_prad_maf.csv'.replace(".csv","")+cancertype+"MutationFreqCorrected.csv"), "w") as thefile:
